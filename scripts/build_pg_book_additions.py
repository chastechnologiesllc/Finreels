...
SHELF_TARGETS: dict[str, list[str]] = {
    "Category: Health & Medicine": ["profession_01_medicine.json"],
    ...
    "Category: Drugs/Alcohol/Pharmacology": ["profession_01_medicine.json", "profession_03_pharmacy.json"],
    "Category: Law & Criminology": ["profession_02_law.json"],
    ...
    "Category: Engineering & Technology": ["profession_06_engineering.json"],
    "Category: Architecture": ["profession_06_engineering.json", "_general.json"],
    "Category: Science - Physics": ["profession_06_engineering.json"],
    "Category: Science - Chemistry/Biochemistry": ["profession_06_engineering.json", "profession_01_medicine.json"],
    "Category: Science - Biology": ["profession_01_medicine.json", "profession_12_agriculture.json"],
    "Category: Science - Earth/Agricultural/Farming": ["profession_12_agriculture.json"],
