...
class FeedProvider extends ChangeNotifier {
  ...
  List<Video> get _allBookVideos {
    ...
    // Bundled Online Hustle + library PDFs first, then selected-category
    // verified books, then general verified library.
    return [
      ..._bookVideos,
  ...
  static final List<Video> _bookVideos = [
    // ── Online Hustle playbooks (bundled PDF) — shown first in Books tab ──
    Video(id:'book_online_hustles_01_surveys_microtasks',
      title:'Online Surveys & Microtasks — FinReels Online Hustle Playbook',
      description:'Practical money playbook for online surveys & microtasks — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_02_affiliate_marketing',
      title:'Affiliate Marketing — FinReels Online Hustle Playbook',
      description:'Practical money playbook for affiliate marketing — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_03_freelance_writing',
      title:'Freelance Writing & Copywriting — FinReels Online Hustle Playbook',
      description:'Practical money playbook for freelance writing & copywriting — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_04_canva_graphic_design',
      title:'Canva Graphic Design Freelancing — FinReels Online Hustle Playbook',
      description:'Practical money playbook for canva graphic design freelancing — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_05_social_media_management',
      title:'Social Media Management — FinReels Online Hustle Playbook',
      description:'Practical money playbook for social media management — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_06_virtual_assistance',
      title:'Virtual Assistance — FinReels Online Hustle Playbook',
      description:'Practical money playbook for virtual assistance — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_07_online_tutoring',
      title:'Online Tutoring — FinReels Online Hustle Playbook',
      description:'Practical money playbook for online tutoring — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_08_transcription_captioning',
      title:'Transcription & Captioning — FinReels Online Hustle Playbook',
      description:'Practical money playbook for transcription & captioning — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_09_content_creation',
      title:'Short-form Content Creation — FinReels Online Hustle Playbook',
      description:'Practical money playbook for short-form content creation — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_10_ai_services',
      title:'AI Prompt Engineering & AI Services — FinReels Online Hustle Playbook',
      description:'Practical money playbook for ai prompt engineering & ai services — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_11_digital_products',
      title:'Digital Product Creation & Sales — FinReels Online Hustle Playbook',
      description:'Practical money playbook for digital product creation & sales — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_12_vtu_airtime_data',
      title:'VTU / Airtime & Data Reselling — FinReels Online Hustle Playbook',
      description:'Practical money playbook for vtu / airtime & data reselling — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_13_video_editing_clipping',
      title:'Video Editing & Clipping — FinReels Online Hustle Playbook',
      description:'Practical money playbook for video editing & clipping — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_14_blogging_seo',
      title:'Blogging & SEO Content Sites — FinReels Online Hustle Playbook',
      description:'Practical money playbook for blogging & seo content sites — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_15_ads_management',
      title:'Facebook & Instagram Ads Management — FinReels Online Hustle Playbook',
      description:'Practical money playbook for facebook & instagram ads management — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_16_dropshipping_pod',
      title:'Dropshipping & Print-on-Demand — FinReels Online Hustle Playbook',
      description:'Practical money playbook for dropshipping & print-on-demand — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_17_web_nocode',
      title:'Web Development & No-code Freelancing — FinReels Online Hustle Playbook',
      description:'Practical money playbook for web development & no-code freelancing — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_18_online_courses',
      title:'Online Course Creation — FinReels Online Hustle Playbook',
      description:'Practical money playbook for online course creation — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_19_ecommerce_mini_import',
      title:'Online E-commerce & Mini Importation — FinReels Online Hustle Playbook',
      description:'Practical money playbook for online e-commerce & mini importation — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
    Video(id:'book_online_hustles_20_digital_agency',
      title:'Digital Marketing Agency — FinReels Online Hustle Playbook',
      description:'Practical money playbook for digital marketing agency — bundled PDF, free offline.',
      channelId:'books',channelName:'Online Hustle Playbooks',publishedAt:_epoch,
      thumbnailUrl:'',),
